...
class Application(Frame):
    ...
    def createWidgets(self):
        ...
        self.cb3.grid(row = 15, column = 4, sticky = W, columnspan = 5)
        ...
        self.cb3.grid(row = 16, column = 4, sticky = W, columnspan = 5)
        ...
        self.cb3.grid(row = 17, column = 4, sticky = W, columnspan = 5)
        ...
        self.results = Text(self, width = 70, height = 5, wrap = WORD, bg = "DodgerBlue2", fg = "blue4", font = ("Arial", 12, "bold"))
    ...
    def calculate(self):
        ...
        if self.people_money.get() == True:
            villains[4] += 1
            var[3] = "Cheap, and don't pay money"
        if self.people_confidence.get() == True:
            villains[0] += 1
            var[4] = "Too brave and confident"
        if self.people_inaccuracy.get() == True:
            villains[5] += 1
            var[5] = "Too inaccurate"
        ...
        final_print = "Scroll all the way down in this box for results\n\n"
        final_print += "Hello, " +self.nament1.get()+ "! Thanks for taking the quiz!\n"
        final_print += "Your results:\n"
        final_print += "You said you wanted "+self.check_personality.get()+"!\n"
        final_print += "Your weapon of choice is: "+self.check_weapon.get()+"\n"
        final_print += "On a scale of 1-10, you chose "+str(self.scalerank.get())+ " as the likelihood that you would use chemicals as a villain.\n"
        final_print += "Your friends would describe you as: '"+self.describe.get()+ "'\n"
        final_print += "You think that, in general, people are:"
        for i in var:
            if i != "":
                final_print += "\n> " +i
        final_print += "\n\nAs a batman supervillain, you would be " + final_villain + "!!!"
